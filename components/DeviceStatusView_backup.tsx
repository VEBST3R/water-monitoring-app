...
const DeviceStatusView: React.FC<DeviceStatusViewProps> = ({ device }) => {
  ...
  const technical = currentDevice?.technical;const buttonDiameter = 200; // Button size increased 2.5 times (100 * 2.5)
  ...
  return (
    <View style={styles.outerContainer}>
      <View style={styles.scrollContentContainer}>
        ...
        <View style={styles.infoCard}>
        ...
        </View>        {technical?.alerts && technical.alerts.length > 0 && (
          <View style={styles.alertsCard}>
            ...
            </View>            {technical.alerts.map((alert, index) => (
